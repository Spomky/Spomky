...
- [symfony/framework-bundle](https://github.com/symfony/framework-bundle) ([v6.4.36](https://github.com/symfony/framework-bundle/releases/tag/v6.4.36), today) - Provides a tight integration between Symfony components and the Symfony full-stack framework
- [symfony/validator](https://github.com/symfony/validator) ([v6.4.36](https://github.com/symfony/validator/releases/tag/v6.4.36), today) - Provides tools to validate values
- [symfony/security-core](https://github.com/symfony/security-core) ([v6.4.36](https://github.com/symfony/security-core/releases/tag/v6.4.36), today) - Symfony Security Component - Core Library
