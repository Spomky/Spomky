...
- [Fix SKIP_WAITING handler missing clients.claim()](https://github.com/Spomky-Labs/pwa-bundle/pull/426) on [Spomky-Labs/pwa-bundle](https://github.com/Spomky-Labs/pwa-bundle) (2 days ago)
...
- [symfony/ai-agent](https://github.com/symfony/ai-agent) ([v0.4.0](https://github.com/symfony/ai-agent/releases/tag/v0.4.0), 2 days ago) - PHP library for building agentic applications.
- [symfony/ai-platform](https://github.com/symfony/ai-platform) ([v0.4.0](https://github.com/symfony/ai-platform/releases/tag/v0.4.0), 2 days ago) - PHP library for interacting with AI platform provider.
- [symfony/ai-azure-platform](https://github.com/symfony/ai-azure-platform) ([v0.4.0](https://github.com/symfony/ai-azure-platform/releases/tag/v0.4.0), 2 days ago) - Azure AI platform bridge for Symfony AI
- [symfony/ai-replicate-platform](https://github.com/symfony/ai-replicate-platform) ([v0.4.0](https://github.com/symfony/ai-replicate-platform/releases/tag/v0.4.0), 2 days ago) - Replicate platform bridge for Symfony AI
- [symfony/ai-open-router-platform](https://github.com/symfony/ai-open-router-platform) ([v0.4.0](https://github.com/symfony/ai-open-router-platform/releases/tag/v0.4.0), 2 days ago) - OpenRouter platform bridge for Symfony AI
- [symfony/ai-store](https://github.com/symfony/ai-store) ([v0.4.0](https://github.com/symfony/ai-store/releases/tag/v0.4.0), 2 days ago) - Low-level abstraction for storing and retrieving documents in a vector store.
- [Spomky-Labs/pwa-bundle](https://github.com/Spomky-Labs/pwa-bundle) ([1.5.3](https://github.com/Spomky-Labs/pwa-bundle/releases/tag/1.5.3), 2 days ago) - PHP library for generating a full featured PWA manifest
- [jakzal/toolbox](https://github.com/jakzal/toolbox) ([v1.106.0](https://github.com/jakzal/toolbox/releases/tag/v1.106.0), 3 days ago) - Helps to discover and install tools
- [api-platform/core](https://github.com/api-platform/core) ([v4.3.0-alpha.1](https://github.com/api-platform/core/releases/tag/v4.3.0-alpha.1), 1 week ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
