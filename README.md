...
- [Merge up 3.4.4 to 4.0.x](https://github.com/web-token/jwt-framework/pull/575) on [web-token/jwt-framework](https://github.com/web-token/jwt-framework) (2 days ago)
...
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([3.4.4](https://github.com/web-token/jwt-framework/releases/tag/3.4.4), 2 days ago) - JWT Framework
...
- [viageo-ch](https://github.com/viageo-ch) (1 day ago)
