...
- [web-auth/webauthn-framework](https://github.com/web-auth/webauthn-framework) ([5.2.4](https://github.com/web-auth/webauthn-framework/releases/tag/5.2.4), today) - FIDO-U2F / FIDO2 / Webauthn Framework
...
- [symfony/framework-bundle](https://github.com/symfony/framework-bundle) ([v8.0.7](https://github.com/symfony/framework-bundle/releases/tag/v8.0.7), 2 days ago) - Provides a tight integration between Symfony components and the Symfony full-stack framework
- [symfony/html-sanitizer](https://github.com/symfony/html-sanitizer) ([v8.0.7](https://github.com/symfony/html-sanitizer/releases/tag/v8.0.7), 2 days ago) - Provides an object-oriented API to sanitize untrusted HTML input for safe insertion into a document&#39;s DOM.
- [api-platform/core](https://github.com/api-platform/core) ([v4.3.0-beta.2](https://github.com/api-platform/core/releases/tag/v4.3.0-beta.2), 2 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
- [symfony/ai](https://github.com/symfony/ai) ([v0.6.0](https://github.com/symfony/ai/releases/tag/v0.6.0), 3 days ago) - Symfony AI is a set of components that integrate AI capabilities into PHP applications
- [symfony/ai-azure-platform](https://github.com/symfony/ai-azure-platform) ([v0.6.0](https://github.com/symfony/ai-azure-platform/releases/tag/v0.6.0), 3 days ago) - Azure AI platform bridge for Symfony AI
- [symfony/ai-replicate-platform](https://github.com/symfony/ai-replicate-platform) ([v0.6.0](https://github.com/symfony/ai-replicate-platform/releases/tag/v0.6.0), 3 days ago) - Replicate platform bridge for Symfony AI
- [symfony/ai-open-router-platform](https://github.com/symfony/ai-open-router-platform) ([v0.6.0](https://github.com/symfony/ai-open-router-platform/releases/tag/v0.6.0), 3 days ago) - OpenRouter platform bridge for Symfony AI
