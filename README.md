...
- [symfony/html-sanitizer](https://github.com/symfony/html-sanitizer) ([v7.3.6](https://github.com/symfony/html-sanitizer/releases/tag/v7.3.6), today) - Provides an object-oriented API to sanitize untrusted HTML input for safe insertion into a document&#39;s DOM.
- [symfony/framework-bundle](https://github.com/symfony/framework-bundle) ([v7.3.6](https://github.com/symfony/framework-bundle/releases/tag/v7.3.6), today) - Provides a tight integration between Symfony components and the Symfony full-stack framework
