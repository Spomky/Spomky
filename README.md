...
- [symfony/framework-bundle](https://github.com/symfony/framework-bundle) ([v8.0.7](https://github.com/symfony/framework-bundle/releases/tag/v8.0.7), 5 days ago) - Provides a tight integration between Symfony components and the Symfony full-stack framework
- [symfony/html-sanitizer](https://github.com/symfony/html-sanitizer) ([v8.0.7](https://github.com/symfony/html-sanitizer/releases/tag/v8.0.7), 5 days ago) - Provides an object-oriented API to sanitize untrusted HTML input for safe insertion into a document&#39;s DOM.
- [api-platform/core](https://github.com/api-platform/core) ([v4.3.0-beta.2](https://github.com/api-platform/core/releases/tag/v4.3.0-beta.2), 5 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
