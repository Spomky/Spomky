...
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v8.1.0-RC1](https://github.com/symfony/http-foundation/releases/tag/v8.1.0-RC1), today) - Defines an object-oriented layer for the HTTP specification
- [symfony/security-core](https://github.com/symfony/security-core) ([v8.1.0-RC1](https://github.com/symfony/security-core/releases/tag/v8.1.0-RC1), today) - Symfony Security Component - Core Library
- [symfony/validator](https://github.com/symfony/validator) ([v8.1.0-RC1](https://github.com/symfony/validator/releases/tag/v8.1.0-RC1), today) - Provides tools to validate values
